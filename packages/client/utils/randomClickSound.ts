import ClickSound from '../src/assets/sounds/orcsound.mp3'
import Say from '../src/assets/sounds/say.mp3'
import Ask from '../src/assets/sounds/ask.mp3'
import Smile from '../src/assets/sounds/smile.mp3'
